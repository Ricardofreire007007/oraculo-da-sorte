  ...
  return (
    <div style={{
      ...
      <p style={{ color: COLORS.textMuted, fontSize: 14, marginBottom: 28, fontStyle: 'italic' }}>
        Mega-Sena &middot; {result.moon.name} {result.moon.emoji} &middot; Número de Vida: {result.lifeNumber}
      </p>
      ...
      <div style={{
        ...
        {result.numbers.map(function(n, i) {
          return <NumberBall key={n} number={n} delay={i * 0.15} />;
        })}
      </div>
      ...
      <div style={{
        ...
        <p style={{ color: COLORS.text, fontSize: 15, lineHeight: 1.8, fontFamily: "'EB Garamond', serif" }}>
          ...
          fase de <em>{result.moon.influence}</em>, o Oráculo combinou a vibração do seu
          Número de Vida <strong style={{ color: COLORS.gold }}>({result.lifeNumber})</strong> com
          a ressonância do dia <strong style={{ color: COLORS.gold }}>({result.dayVibration})</strong>.
          Os números revelados estão alinhados com a sua energia cósmica pessoal.        </p>
...
export default function App() {
  ...
  var handleConsult = function() {
    ...
    setTimeout(function() {
      var oracleResult = generateMysticNumbers(profile.birth_date);
          ...
          <div style={{ textAlign: 'center' }}>
            <div style={{
              ...
              <p style={{ color: COLORS.textMuted, fontSize: 14, marginBottom: 24 }}>
                O Oráculo combina sua numerologia pessoal com a energia da {moon.name} para revelar 6 números sagrados.
              </p>

              {consulted ? (
                <div>
                  <p style={{ color: COLORS.amber, fontSize: 15, fontStyle: 'italic' }}>
                    &#127769; Você já consultou o Oráculo hoje.
                  </p>
